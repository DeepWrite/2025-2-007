---
title: 007-17 노준영의 코멘트b (과제-04) 
layout: home
nav_order: 17
parent: 007-13 김강현 (과제-04)
permalink: /asmt-04/007-13/comment-007-17
---
...
## 코멘트
서론에서 배경과 딜레마, 본인의 주장 등이 잘 정리되었다. 하지만 본인이 어떤 논증 방식을 쓸 것인지가 드러나지 않는다. 그저 '규범적 구조임을 보인다'는 결론일 뿐 논증 방식은 아니므로 어떤 방식을 사용할 것인지 표현해주는 것이 필요해보인다. 본론의 1, 2단락에서는 앞서 배운 OREO 구조를 활용하여 첫 문장에 자신의 근거를 표현해주면 이해에 더 큰 도움이 될 것 같다. 그리고 본론의 연결 구조가 이해가 되기 어렵다. 각 단락이 너무 정보 전달에 치중하고 있으며 어떤 추론 방식을 사용하였는지 모호하고, 결국 본론으로부터 드러내고자 하는 본인의 논증이 무엇인지 보이지 않는다. 예를 들어서 자율주행차 알고리즘이 생명 가치 분배 구조임으로 투명한 공개가 필요함을 논증하고 싶다면 이런 문장을 2단락에 녹여내주는 것도 필요해보인다.
반론과 재반박 같은 경우에는 본인의 논증과 다른 부분인 규범적 정당성이 약화될 필요성을 재반박하며 본인의 논증을 강화하고 있다. 다만 이 과정에서 본인의 논증의 약점이 있다면 함께 넣어주면 좋을 것 같다. 결론에서 본인의 논증이 미치는 범위를 잘 표현하여 오해의 소지를 제거하였다. 다만 본인의 글이 가지고 있는 함의는 나타나지 않고 그저 논증의 요약과 정리만 반복되고 있다. 함의를 추가하면 더 완성된 글이 될 것 같다.
