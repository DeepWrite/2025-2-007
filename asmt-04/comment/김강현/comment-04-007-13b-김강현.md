---
title: 007-13 김강현의 코멘트b (과제-04) 
layout: home
nav_order: 13
parent: 007-09 이준표 (과제-04)
permalink: /asmt-04/007-09/comment-007-13
---
...
서론은 필자의 핵심 주장인 공공안전의 중요성과 데이터 감시의 중요성을 두 가지 논증을 통해 증명하겠다고 예고합니다. 하지만 본론에서 이 두 논증이 결합되어 최종 결론을 도출하는 과정이 논리적으로 단절되어 있습니다. 본론 1은 공공안전과 적극적 자유 보장을 논하고, 본론 2는 데이터 감시와 정확한 집단적 판단, 공공안전 보장을 논합니다. 여기서 핵심 주장이 '데이터 감시가 민주주의 사회에서 정당하다'는 결론으로 수렴되려면, 데이터 감시가 초래할 수 있는 자유의 침해 위험보다 공공안전 보장이 어떻게 더 높은 가치를 가지며, 데이터 감시가 시민의 자유를 실질적으로 증가시킬 수 있는지를 고려해야 합니다. 그러나 공공안전의 필요성과 데이터 감시의 효율성을 병렬적으로 나열하는 데 그쳐, 주장하는 바의 근본적인 정당성을 확립하는 데 필요한 부분이 부족하다고 생각됩니다.

본론 3에서 제시된 권위주의적 감시 체제로의 전환 위험이라는 반론은 정부 감시 옹호론에 대한 위험성을 구체적으로 언급한 주장입니다. 그러나 본론 4의 재반박은 이 위험성을 민주주의 제도와 가치의 결함이라는 외적이고 추상적인 문제로 전환시키며 논점을 회피하고 있습니다. 반론이 중국 사회 신용 시스템과 같은 데이터 감시 수단 자체의 위험 가능성을 제기했을 때, 재반박은 민주주의 사회 내에서 데이터 감시 기술이 권위주의적 방식으로 확장되지 않도록 통제할 수 있는 구체적이고 실질적인 메커니즘을 제시해야 설득력을 얻을 수 있을 것이라 생각됩니다. 일반적인 민주주의 제도의 언급만으로는 부족하다 생각됩니다.
