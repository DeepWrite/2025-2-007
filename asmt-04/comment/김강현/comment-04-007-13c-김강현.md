---
title: 007-13 김강현의 코멘트c (과제-04) 
layout: home
nav_order: 13
parent: 007-17 노준영 (과제-04)
permalink: /asmt-04/007-17/comment-007-13
---
...
이 글은 환경 문제가 행위성을 가진 자들이 일으키며, 비인간도 행위성을 가진다는 구조로 비인간의 환경 문제 행위자 역할을 연역적으로 논증하고자 합니다. 문제는 이 논증의 핵심 축인 '행위성' 개념의 일관성 상실입니다. 본론 1에서 행위성을 '내면의 정신작용이 외면의 신체활동으로 실행된 결과', 즉 목적과 의도를 가진 행동이라는 전통적인 정의로 설정합니다. 하지만 본론 2에서 비인간에게 행위성을 적용하기 위해 '고유한 힘과 각자의 경향성'을 언급하며, 사실상 행위성의 개념을 느슨하게 확장하고 있습니다. 이는 서론과 본론 1에서 설정한 논증의 기초 전제를 스스로 무너뜨리며, 연역적 논증을 크게 약화시키고 있습니다. 필자가 전통적 정의를 고수할 것인지, 아니면 행위성의 정의 자체를 확장해야 한다는 것을 주장할 것인지를 명료하게 할 필요가 있습니다.

본론 3의 반론은 비인간의 작용이 '의도와 목적이 없는 물리적 작용'일 뿐이라며 필자의 최초 정의를 공격합니다. 그러나 본론 4의 재반박은 이 반론에 맞서기 위해 '비인간은 의식적으로 목적을 설정할 수 없다'는 점을 인정하면서, 목적을 '생존, 안정, 기능 유지 등을 위해 궁극적으로 지향하는 바'로 재정의합니다. 이는 반론을 피해가기 위해 자신이 본론 1에서 세운 논증의 핵심 전제를 스스로 수정하는 것입니다. 재반박 단락은 새로운 정의를 도입한 후, 그 새로운 정의가 왜 드런지에 대한 정당화를 앞에서 언급한 부분에 모순되지 않게 제시했어야한다고 생각합니다. 
