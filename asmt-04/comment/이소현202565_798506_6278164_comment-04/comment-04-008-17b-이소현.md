---
title: 008-17 이소현의 코멘트b (과제-04) 
layout: home
nav_order: 17
parent: 008-09 심예은 (과제-04)
permalink: /asmt-04/008-09/comment-008-17
---
...
이 글은 인적 자본 형성의 시기와 방식에 대한 논쟁 속에서 12세 이후의 개입이 더 효율적이라는 점을 논증하는 글이다. 서론에서는 논쟁의 쟁점을 명확히 설정하고, 주장의 방향과 이를 뒷받침할 두 가지 핵심 논거를 제시하며 독자의 이해를 돕는다. 이 부분에서 딜레마가 드러나 있기는 하나, 한 문장으로 명확히 제시되면 독자의 이해를 돕는 데 더 좋을 것 같다. 본론에서는 두 논지가 단계적으로 설명되어 논리적 연결성이 드러난다. 그런데 '12세 이전 영유아는 경험을 해도 이를 능동적으로 받아들일 수 있는 능력이 결여된다' 라는 주장에 대한 구체적인 근거가 부족하여 이 부분이 보충되면 좋을 것 같다. 반론과 재반박 부분에서는 실제 조기 개입 프로그램을 인용하면서 수동적 수용의 한계를 짚어내어 중심 주장을 효과적으로 방어하고 있다. 결론에서는 주장 내용을 잘 요약하고, 논증문의 시사점과 한계에 대한 서술도 포함되어 있다. 전반적으로 논리적 구조가 명확하고 학술적 논쟁을 효과적으로 활용한 설득력 있는 글이다.
