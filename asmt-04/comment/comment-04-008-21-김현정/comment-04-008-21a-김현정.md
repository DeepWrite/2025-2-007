...
permalink: /asmt-04/008-21/comment-008-17
---
...
서론에서 앞으로 전개할 두 가지 논증을 디지털 프라이버시가 기본권이며, 동의 없는 개인정보 수집은 프라이버시(=기본권)을 침해한다는 점으로 정확하게 제시하였다. 본론에서는 개인정보가 당사자의 의사와 무관하게 수집 및 활용될 경우, 개인이 자신의 삶에 대해 통제력을 상실하게 되므로 자기결정권과 관련하여 디지털 프라이버시가 기본권이라는 것을 논리적으로 설득하였다. 그러나 반론에서는 본론의 두 논증 구조에 대한 논리적 결함을 지적하기보다는, 총체적인 주장에 대해 한계점을 제시하는 것에 가까운 것 같다. 결론 부분에서는 ‘본 논문에서 데이터 기반의 맞춤형 서비스가 현대 사회에서 중요한 역할을 한다는 사실을 부정하는 것은 아니다.’라는 문장과 같이 오해를 줄이고 의견을 명확히 할 수 있도록 적절하게 서술하였다. 
