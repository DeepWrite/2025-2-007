---
title: 007-15 최낙용의 코멘트b (과제-04) 
layout: home
nav_order: 15
parent: 007-31 윤세현 (과제-04)
permalink: /asmt-04/007-31/comment-007-15
---
...
- 코멘트를 받는 학생: `007-31 윤세현(코멘트를 받는 학생 이름)` 

---

## 코멘트

글의 흐름이 선명하고 읽기 쉽게 잘 쓰신 것 같습니다. 서론에서 딜레마와 전개 계획을 또렷이 제시해 독자인 저로 하여금 논점을 바로 파악할 수 있었습니다. 다만 서론 끝에 “의사결정능력이 상실돼도 동일성은 유지되므로 사전지시는 도덕적 권위를 갖는다”처럼 핵심 논제를 한 문장으로 미리 제시하면 안내 기능이 강화될 것 같습니다. 본론은 주장→반론→재반박의 구조가 명료합니다. 다만 Parfit 반론을 다룰 때 동일성의 기준(물리적 연속성+관계적/사회적 연속성)을 명시하고 그 기준이 충족될 때 사전지시의 권위가 왜 계속 귀속되는지까지 한 문장으로 연결해 주면 논증이 단단해질 것 같습니다. 결론은 요약을 잘해주셨지만 적용 범위와 한계를 짧게 밝히면 과도한 일반화를 피하면서 완결성이 좋아질 것 같습니다.
