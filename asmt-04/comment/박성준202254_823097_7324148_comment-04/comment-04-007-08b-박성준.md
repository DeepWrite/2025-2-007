---
title: 007-08 박성준의 코멘트b (과제-04) 
layout: home
nav_order: 08
parent: 007-12 한유정 (과제-04)
permalink: /asmt-04/007-12/comment-007-08
---
...
이 글은 “국가 책임” 중심 보도가 재난 보도에서 지배적인 양식이 되었음을 짚고, 그 결과가 언론의 본질적 기능(다원적 정보 제공)과 시민의 정치적 주체성을 약화시킨다는 점을 논증한다. 서론은 국내 사례와 선행연구를 배경으로 딜레마를 명확히 설정하고, 본론의 전개 계획을 제시하여 안내 기능을 수행한다. 본론은 공정성, 자율적 판단이 결과가 아니라 조건에 의존한다는 전제, 국가 책임 프레이밍이 책임의 주체를 단순화 및 고정화하여 시민을 수동적 존재로 만든다는 핵심 근거를 차례로 배치했다. 이어 “국가 책임 프레이밍이 오히려 참여를 촉발한다”는 반론을 도입하고, 참여의 질을 구분하는 재반박으로 구조적 대응을 시도한다. 결론은 전체 논증을 요약하면서, 국가 비판 자체를 부정하는 것이 아니라 단일 프레임에의 고착이 문제임을 분명히 하여 적용 범위를 제한한다. 다만, 1-2단락 사이의 추론적 연결을 한 문장으로 더 분명히 해 주면 근거의 누적성이 강화될 것 같다.
