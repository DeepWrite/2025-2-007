---
title: 007-11 윤세현의 코멘트c (과제-04) 
layout: home
nav_order: 11
parent: 007-23 조수연 (과제-04)
permalink: /asmt-04/007-23/comment-007-11
---
...
이 글은 "보편적 기본소득이 복지국가의 대안인가 위협인가"라는 주제를 중심으로 UBI가 빈곤층을 직접적으로 겨냥하지 못하며 복지체제의 정치적 기반을 불안정하게 만든다고 논증하고 있다. 이를 논증하기 위해 제시되는 각각의 근거가 깊이 있고 엄밀한 수준이라고 보이지만, 글의 핵심 논증 구조가 드러나지 않으며 여러 주장들의 나열을 통해 자신의 주장의 정당성을 확보하는 수준에 그친다는 점이 아쉽다. 예를 들어, 첫번째 단락과 두번째 단락은 각각 "보편 지원이 재정 문제를 야기한다"와 "무조건성은 사회적 연대와 제도 정당성을 약화한다"를 다루고 있는데 이 단락 간 연결이 긴밀하지 못하고 단절되어있다는 인상을 준다. 이는 UBI가 가지는 여러 취약한 속성들을 최대한 다루려고 하다보니 발생한 문제로 보이며, "재정 지속가능성"이나 "제도적 정당성" 등 여러 핵심 가치들 중에 하나만 선정하여 깊이 있게 논증한다면 더 설득력 있는 글이 탄생할 것이라 생각한다.
