---
title: 007-11 윤세현의 코멘트a (과제-04) 
layout: home
nav_order: 11
parent: 007-07 신주혁 (과제-04)
permalink: /asmt-04/007-07/comment-007-11
---
...
이 글은 "연인 관계에서 변심에 의한 일방적인 이별 통보는 부당하지 않다"는 주장을 중심으로 묵시적 계약이라는 개념을 통해 일방적 이별 통보를 정당화하고 있다. 다만 서론에서 묵시적 계약이라는 새로운 개념을 중심으로 논증한다고 했던 것에 비해 본문에서 묵시적 계약 개념을 명확히 하지않은 상태로 논증을 진행하는 것 같아 보완이 필요해보인다. 묵시적 계약은 명시적으로 성립되는 계약이 아니라는 점 외에도, 가령 묵시적 계약에 해당하는 다른 예시에는 무엇이 있다거나, 묵시적 계약의 당사자는 어떤 권리를 가질 수 있는 지 등의 부연 설명이 추가적으로 제시되면 독자들의 이해를 촉진할 수 있을 것이다.

또한 예상 반박과 재반박 단락을 추가할 경우, 필자의 논증 구조가 더 탄탄한 인상을 줄 것이다. 예를 들어, 관계의 단절을 일방적으로 통보하는 것이 '연인에 대한 의무'가 아니라 '타인에 대한 일반적인 의무'에 속한다고 반론한다면 이별의 통보 행위의 정당성을 다시 고려해볼 가능성이 생기기 때문이다. 전체적으로 필자의 논증 구조는 긴밀하게 연결되어있지만 그럼에도 각 전제들에 대해 충분히 반론을 제기할 여지가 남아있다고 보이기에 이 부분을 보완하면 완벽한 글이 될 것이다.
