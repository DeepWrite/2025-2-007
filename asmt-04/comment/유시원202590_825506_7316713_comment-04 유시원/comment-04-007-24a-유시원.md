---
title: 007-24 유시원의 코멘트a (과제-04) 
layout: home
nav_order: 24
parent: 007-04 홍용찬 (과제-04)
permalink: /asmt-04/007-04/comment-007-24
---
...
이 글은 서론에서 논제와 전개 방향이 명확하게 제시되어, 독자가 글의 전체 구조를 쉽게 예측할 수 있게 합니다. *AI 채용 시스템은 공정성을 제한한다*는 중심 논제를 분명히 하고있고, 사회적 맥락 속 문제 의식을 설득력 있게 드러내고 있습니다.   
다만 본론의 논증은 근거들이 서로 병렬적으로 배열되어 있어, 공정성 개념 정의 -> AI 설계 구조 -> 결과적 불평등 으로 이어지는 계열적 발전 구조가 약하게 느껴집니다. 각 단락이 이전 단락을 전제로 새로운 논거를 추가하는 구조로 개선된다면, 논증의 필연성과 추론의 깊이가 강화될 것 같습니다. 또한 반론-재반박 부분은 형식적으로는 충실하나, 실제 논쟁의 긴장이 부족하므로 반론의 구체성을 높이고 그에 대한 논리적 대응을 확장하면 좋을 것 같습니다. 
