---
title: 008-02 이현서의 코멘트b (과제-04) 
layout: home
nav_order: 02
parent: 008-14 김리아 (과제-04)
permalink: /asmt-04/008-14/comment-008-02
---
...
이 글은 “기후위기의 원인은 무엇이며, 우리는 어떻게 공정하게 대응할 수 있는가?”라는 주제를 바탕으로, 인간 활동이 기후위기의 주요 원인임을 과학적으로 논증하고, 개발도상국의 부담을 최소화하는 해결책으로 ‘공정한 전환’을 제시하고자 한다. 서론에서 기후위기의 원인을 둘러싼 논쟁(IPCC vs 기후 회의론자)을 선명하게 정리하고 있어 배경 제시의 밀도는 높으나, 중심 쟁점이 다소 불명확해지는 측면이 있다고 보일 수도 있음을 조심스럽게 제시한다. 서론 초반에는 “기후변화가 인간 활동에 기인하는가?”라는 과학적 논쟁이 주요 쟁점처럼 보이지만, 이후 논제는 “개발도상국에 부당한 압력을 가하지 않으면서 기후위기를 해결할 수 있다”는 정책적 주장으로 전환된다. 이 과정에서 두 쟁점 간 연결고리가 충분히 설명되지 않아, 독자가 글의 핵심 논지가 어디에 초점을 두고 전개되는지 혼동할 우려가 있다. 논제의 중심이 ‘원인 논쟁’에서 ‘공정한 대응 가능성’으로 바뀐다면, 그 전환이 조금 더 논리적으로 설득력 있게 이루어질 필요가 있다.

본론에서도 이 같은 연결성 문제는 일부 반복되는 것으로 보인다. 1단락에서는 인간 활동이 기후위기의 결정적 원인임을 과학적 데이터와 문헌을 통해 강하게 뒷받침하고 있지만, 2단락에서 공정한 전환을 제안하는 과정으로 이동할 때 그 연결 고리, 즉 ‘왜 인간 활동이 원인이라는 사실이 곧 공정한 전환의 필요성을 뒷받침하는가’에 대한 논리적 전이가 명확하지 않다. 중간에 “그렇다면 책임의 문제는 누구에게 있는가?” 또는 “인간 활동이 원인이라면, 책임의 분배는 어떻게 이뤄져야 하는가?”와 같은 추론적 질문을 매개로 단락 간 논리 흐름을 유도하는 장치가 있었더라면 전체 글의 응집력은 더욱 높아졌을 것이다.

결론에서는 논의의 적용 범위나 한계를 명시적으로 설정함으로써 오해의 여지를 줄이고 글의 논증적 완결성을 높일 필요가 있다. 현재 글은 주장 자체를 반복하고는 있으나, 이 논의가 어떤 조건과 맥락에서 유효하며, 어떠한 반례나 미해결 쟁점을 남기는지를 분명히 밝히지 않아, 결론이 다소 일반화되는 인상을 주는 것처럼 읽힐 수도 있다.
