---
title: (개선) 과제-07 개인별 논증 구조 작성하기 007-02 김준형
layout: home
nav_order: 99
parent: 007-02 김준형 (과제-07)
permalink: /asmt-07/007-02/revision
---

# (개선) 과제-07 개인별 논증 구조 작성하기 007-02 김준형 

## 개선 사항 메모

- 딜레마 (A), (B)의 구조에 있어 직접적인 대립 구도가 나타날 수 있도록 내용을 일부 수정하였다. 

- 전제3에서 사용했던 각 국가가 선택한 *우연적* 경제 정책이라는 표현이 다소 오해의 여지가 있어. *채택한 특정한 경제 정책* 으로 수정하였다. 

- 본 논증의 범위를 명확히 하기 위해, 권위주의 정치 체제의 정의를 추가하였다. 
...
- **권위주의 정치 체제**: 본 논증에서 *권위주의 정치 체제(Authoritarian Regime)* 는 민주적 선거 절차가 결여되거나, 권력이 소수 엘리트나 단일 지도자에게 집중되고, 시민적, 정치적 자유가 억압되는 정치 체제를 의미한다.
...
- 딜레마 구조
  ...
  - **(A)** 권위주의 체제는 국가 역량을 총동원하여 일원화된 경제 정책을 신속하고 효율적으로 추진할 수 있다는 강점 보유

  - **(B)** 그러나 이는 **견제받지 않는 권력**이라는 속성에서 기인하므로, 정책 실패 시 수정이 불가능하고 부정부패가 만연하여 오히려 경제 구조를 장기적으로 왜곡하고 취약화시킬 위험 내포
...
- **논제:** 권위주의 정치 체제는 경제 발전을 위한 필요조건이 아니다. 
  ...
  - **전제3:** '개발 독재'의 성공 사례의 핵심적인 원인은 권위주의 정치 체제 그 자체가 아니라, 권위주의 체제 하에서 자율적으로 채택한 특정한 경제 정책(수출 주도 산업화, 인적 자본 투자 등)으로 인한 것이다. 
