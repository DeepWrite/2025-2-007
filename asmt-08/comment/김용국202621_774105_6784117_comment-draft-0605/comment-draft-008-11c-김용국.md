---
title: 008-11 김용국의 코멘트c (과제-08) 
layout: home
nav_order: 11
parent: 008-04 송유나 (과제-08)
permalink: /asmt-08/008-04/comment-008-11
---
...
- **종합적 평가**: 논제의 진술이 명확하고 용어의 사용도 엄밀한 검증을 통해 적절히 이루어졌다.
...
- **종합적 평가**: 논증 과정이 전체적으로 완결성 있게 제시되었으며, 사례와 학술적 근거를 통해 적절히 뒷받침되고 있다.
...
- **종합적 평가**: 논문의 딜레마는 용기라는 덕목을 위한 두려움 인식의 필요성을 두고, "용기"라는 덕목은 두려움이 있을 때에도, 없을 때에도 성립할 수 있을 것 같다는 모호한 상황에서 발생하고, 이는 적절히 설정된 딜레마라고 볼 수 있다.
...
- **종합적 평가**: 논문은 용기라는 덕목에 대해서 논쟁의 여지가 있는 주제를 쟁점으로서 잘 설정하였고, 딜레마를 해소하기 위한 적절한 논증을 하고 있다.
...
- **종합적 평가**: 논증의 구조는 다음과 같다.
  - 1. 도덕적 덕목은 내면적 성향이다.
  - 2. 내면적 성향은 일관적 판단 구조의 형성에 기반한다.
  - 3. 판단력(위에서의 판단 구조)은 내적 갈등이 존재할 때 작동한다.
  - 4. 두려움이 없으면 용기와 유관한 내적 갈등의 대상이 사라진다.
  곧, 두려움이 없으면 용기와 유관한 내적 갈등, 판단력(판단 구조), 내면적 성향, 도덕적 덕목의 부재로 이어지는 것으로 이해할 수 있는 연역적 논증의 구조를 보이고 있다. 또, 여기서 논증의 구조가 반박될 수 있는 부분을 적절히 드러내며 재반박을 통해 논증을 강화하고 있다.
...
- **종합적 평가**: 기존의 문헌과 연구가 적절히 활용되어 논쟁의 필요성을 밝히고 있고, 적절한 학술 자료의 활용을 통해 자신의 전제를 강화하고 있다.
...
서론에서 적절히 주제에 대한 소개와 기존의 연구, 자신의 논제 방향을 소개하고 있다. 다만, 기존 연구의 소개에 있어서 직접적으로 학술자료나 논문의 각주 혹은 내주 처리가 되면 좋을 듯하다.
...
#### **3. 본론 작성 종합 평가**: 
본론에서의 논증 구조가 체계적이며, 그 내용도 일부 문헌으로 설명되고 있다. 다만, 일부 전제는 사고실험만으로 논증되고 있는데, 더 많은 학술 문헌으로 보조되는 것이 논문을 풍부하게 만드는 방법이라고 생각된다.
...
#### **4. 결론 작성 종합 평가**: 
결론에 포함되어야 하는 내용이 모두 잘 포함되었다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

논제의 설정과 딜레마의 해소를 다룸에 있어 적절한 표현을 사용하고, 형식적으로도 완결된 모습을 보인다. 언급했던 것처럼, 군데군데 추가적으로 인용할 수 있는 논문이 더 있지 않을까 생각한다. 논문을 더욱 학술적이고 풍부하게 만들 수 있을 것으로 기대한다.

### B. 논증에 대한 평가

논증 구조가 완결적이며, 그 내용이 타당하게 보조되고 있다. 