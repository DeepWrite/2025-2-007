---
title: 008-20 조재성의 코멘트b (과제-08) 
layout: home
nav_order: 20
parent: 008-13 김은수 (과제-08)
permalink: /asmt-08/008-13/bomment-008-20
---
...
- **종합적 평가**: 
사실 경쟁이라는 것에 대한 정확한 설명이 필요할 것 같다.
...
- **종합적 평가**:
'우선, 인지심리학적 관점에서~'로 시작되는 문단 2개가 중복된다.
...
쟁점과 딜레마를 올바르게 설정하여 논문과의 연결성이 높은 것 같다.
...
논제 설정이 이 글을 읽어나가는데 수월하게 해준 것 같다.
...
2번째 논증과 3번째 논증이 겹치는 부분이 너무 많다는 생각이 들었다. 2번째 논증의 후반부에도 정보 제한과 경쟁을 나누어 설명했을 때 제한이 판단을 방해한다는 내용이 3번째 논증과 너무 겹친다고 생각한다.
...
쟁점 및 딜레마에 대한 학자들의 논의가 필요할 것 같다.
...
서론이 교수님께서 말씀하신 양식들을 모두 반영한 것 같다. 그러나 선행연구와 학술 논쟁에서 각 의견에 대한 학자를 표현하는 것이 필요할 것 같다.
...
사실 경쟁만이 유일한 수단이라고 제시하였는데, 유일성을 논증하기에는 내용이 부족하다고 생각한다. 
...
- [ ]론이 **적용 가능한 영역**이 명확하지 않다.  
- [ ] 결론이 **과도하게 확대**되거나, 암묵적으로 일반화되고 있다.  
- [ ] **다루지 않은 쟁점**에 대해서도 본 논문이 다룬 것처럼 오해될 수 있다.
- [x]와 기여에 대한 서술을 통해, 해당 논문이 해결한 문제의 성격, 기존 연구와의 유사점과 차별점을 효과적으로 표현하고 있다. 또한, 결론이 적용 가능한 영역이 명확하고, 새로운 주장 없이, 앞선 논의의 정리와 재강조로 마무리되었다. 오해의 여지가 있는 경우 다루지 않은 쟁점에 대해서도 본 논문이 다룬 것처럼 오해되지 않도록 하는 주의적 서술이 취해지고 있다. 
...
#### **4. 결론 작성 종합 평가**: 
사실 경쟁을 통해 이루어지는 방식으로 미루어 보아 현재 알고리즘 방식을 통한 인지적 고립을 유도하는 현 플랫폼 구조는 잘못된다고 생각이 든다. 이것이 본고가 주장하는 바가 맞다면 언급을 해주었으면 좋겠다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

본론 부분에 중복된 부분에 대한 수정이 필요할 것 같다. 1,2번째 논증이 주어졌을 떄 3번째 논증이 굳이 왜 주어지는지에 대한 납득이 필요할 것 같다.

### B. 논증에 대한 평가

사실 경쟁이 유일한가에 대한 부분, 사실 경쟁의 정의에 대한 언급이 필요할 것 같다.