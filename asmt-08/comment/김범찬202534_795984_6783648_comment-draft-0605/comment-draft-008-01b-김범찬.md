---
title: 008-01 김범찬의 코멘트b (과제-08) 
layout: home
nav_order: 01
parent: 008-13 김은수 (과제-08)
permalink: /asmt-08/008-13/comment-008-01
---
...
가짜뉴스는 규제가 아닌 사실 경쟁으로 대응해야 한다라는 논제가 명확히 제시되어 있으며, 글 전체에 걸쳐 일관되게 표현되어 있다.
...
논증 구조(전제 제시->본론 전개->반론->재반박->결론)가 잘 정리되어 있고, 논제와 논증 사이의 연결이 일관적이다.
...
“규제 vs 사실 경쟁”이라는 대립 구조가 명확하게 제시되고, 기존 논쟁 지형도 잘 정리되어 있다. 다만 규제론 측 주장에 대한 요약이 다소 피상적인 느낌이 있다. 딜레마 구조를 규제=시민무력화로 일원화하는 것이 자칫 이분법적 접근을 초래할 가능성이 있다.
...
명확한 논제를 바탕으로 사회적으로 규명 실익이 있는 주제를 설득력 있게 논증하고 있다.
...
연역적 논증이 자세하고 논리적으로 진행되고 있다. 다만 인용 연구가 핵심 논지를 뒷받침하기에 다소 간접적일 수 있다(예컨대 Gilbert의 연구 사례). 
...
#### **5. 서론 작성 종합 평가**: 
전체 논의 요약과 최종 결론 도출이 잘 정리되어 있다. 다만 “사실 경쟁”이라는 중심 개념에 대한 정의나 한계 설명이 부족한 감이 있다.
...
#### **3. 본론 작성 종합 평가**: 
구조적으로 탄탄하며, 각 절은 주어진 양식에 따라 잘 작성되었다. 다만 본문 2-3에서 다소 반복적인 서술이 많아 실질적 논점 전개는 다소 느슨한 인상을 준다. 
...
#### **4. 결론 작성 종합 평가**: 
전체 논의 요약과 최종 결론 도출이 잘 정리되어 있다. 다만“규제를 완전히 배제하지는 않는다”는 주장과 “사실 경쟁만이 해법이다”는 주장 사이의 긴장이 해결되지 않고 남아 있다. 이로 인해 최종 결론이 다소 양립 불가능한 가치의 병치처럼 보일 수 있다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

서론부, 본론부, 결론부 모두 명확히 설정된 논제 아래 구조적으로 잘 논증되었다. 서론에서의 논의 구조 소개, 본론에서의 구조적 논증, 결론에서의 요약이 모두 이해하기 쉽게 작성되었다.

### B. 논증에 대한 평가

논증 역시 명확히 설정된 논제에 대해 연역적으로 심도 있게 논증되었다. 다만, 다소 반복적인 서술이 있는 점, 그리고 규제의 배제와 경쟁 간 다소 이분법적으로 보일 수 있는 점에서 약간의 우려가 있다. 