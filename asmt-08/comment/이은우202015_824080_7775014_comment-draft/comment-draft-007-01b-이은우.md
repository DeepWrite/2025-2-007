---
title: 007-01 이은우의 코멘트b (과제-08) 
layout: home
nav_order: 01
parent: 007-19 채민정 (과제-08)
permalink: /asmt-08/007-19/comment-007-01
---
...
- **종합적 평가**: 
경제 발전에 있어서의 권위주의에 대한 민주주의의 우월성을 글 전체에서 일관되고 명료하게 지시하였습니다. 
...
- **종합적 평가**:
대상을 정의하거나 사회적 현상의 원인을 분석할 때 앞서 이루어진 연구들을 적극 사용하여서 설득력 있었습니다. 또한 각 문단마다 소제목을 첨부하셔서 글의 내용을 미리 파악하기가 수월했습니다.
...
- **종합적 평가**: 
앞선 코멘트와 마찬가지로 논문을 통해 주장하고자 하는 바를 명확하게 규정지었습니다.
...
- **종합적 평가**: 
전제1, 정치 체제를 정의하는 단계에서 충분한 논증이 포함되었다고 판단하기는 어려웠습니다. 정의, 구분의 단계인 만큼 논증의 한 단계를 차지한다기보다는 다른 논증의 서두에 오면 좋을 것 같다고 생각했습니다. 또한 전제 2와 전제3의 순서가 바뀌면 좋겠다고 조심스럽게 작성해봅니다. 전제1에서 정치 체제 그 자체를 다루었으므로 다음 논증 단계에서 그러한 정치 체제와 정책 합리성의 관계를 밝히고, 마지막 단계에서 정책 합리성이 경제 발전의 주요 원인임을 밝힌느 것이 더 매끄러울 것 같습니다.
...
- **종합적 평가**: 
브렉시트에 관한 논문의 최종 결론 뿐만 아니라 그 결론에 이르기 위한 양적 연구, 데이터 분석도 함께 사용되었습니다.
...
#### **5. 서론 작성 종합 평가**: 
서론에 포함되어야 할 요소들을 모두 확인할 수 있었습니다. 첫 번째 문단에서 문제 상황 내지 연구의 필요성을 설명할 때 경험적 사례의 구체적 예시를 같이 언급하면 더욱 좋을 것 같습니다.
...
#### **3. 본론 작성 종합 평가**: 
전제1 각 체제의 정의와 특성에서 민주주의 체제는 자유화와 포용성이 충분히 보장된 체제라고 정의하셨는데, '충분히'가 정확히 의미하는 바를 명시해주시면 좋을 것 같습니다. 또한 전제2에서 정책이 국가 경제 발전의 핵심인 근거로 정부 실패를 제시해주셨는데 의도하신 바는 충분히 이해되지만, 정부 실패라는 실례가 존재하므로 경제 발전에 있어 국가의 역할이 중요하다면, 시장 실패를 제시할 때는 시장의 역할이 더 중요하다고 주장해야 하는 문제가 발생할 수 있습니다. 
...
#### **4. 결론 작성 종합 평가**: 
예상반론-재반박 단계를 본론 마지막 부분에 배치함으로써 결론부는 응집력있고 필요한 요소들로만 구성되어있다는 인상을 받았습니다. 

## 5. 총평 (앞서 언급된 내용 제외했습니다)

### A. 표현, 형식, 구성 측면에 대한 평가

문단이 하나밖에 없는 단락에서는 굳이 소제목을 붙이지 않아도 된다고 생각합니다. 

### B. 논증에 대한 평가

대상의 정의를 내리고 특징을 기준으로 구분하는 것은 정보 전달에 필수적이지만 논증에 해당하지는 않다고 생각합니다. 