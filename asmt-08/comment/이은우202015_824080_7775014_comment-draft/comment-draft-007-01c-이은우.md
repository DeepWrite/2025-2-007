---
title: 007-01 이은우의 코멘트c (과제-08) 
layout: home
nav_order: 01
parent: 007-22 오서준 (과제-08)
permalink: /asmt-08/007-22/comment-007-01
---
...
- **종합적 평가**: 
장기 경제 발전에 있어 권위주의보다 민주주의가 우월하다는 일관된 논제를 사용하였습니다.
...
- **종합적 평가**:
논증을 뒷받침하기 위한 선행 연구들, 특히 혁신 기업가에 대한 논문을 적극적으로 사용하였습니다.
...
- **종합적 평가**: 
제시된 논제의 딜레마라기보다는 선행 연구에서 확인할 수 있었던 딜레마에 가깝다고 생각합니다.
...
- **종합적 평가**: 
앞선 코멘트와 마찬가지로 논제가 명확했고 학문적으로 탐구할 가치가 있었습니다.
...
- **종합적 평가**: 
본론 첫 번째 단락의 지속 가능성과 두 번째 단락의 경제 발전 핵심 주체를 매개할 수 있는 문장이 포함되면 좋을 것 같습니다.
...
#### **5. 서론 작성 종합 평가**: 
사업가의 위험 회피 성향을 연결짓기 위한 부연설명의 필요성은 충분하지만 연결지으신 이후 이에 대한 딜레마는 제시되지 않은 것 같습니다. 서론 첫 번째 문단에 제시된 딜레마는 논제와 관련되어있다기보다는 기존의 정치경제학 영역에서 이루어진 딜레마인 듯합니다. 
...
#### **3. 본론 작성 종합 평가**: 
전제n을 사용하여 어떠한 결과를 도출할 수 있다는 방식의 정리를 통해 독자의 이해를 적극적으로 도왔다고 생각합니다. 다만 예상반론은 이미 본론에서 지적된 권위주의의 사례이고 재반론 역시 이전에 서술된 민주주의적 관점이었다고 느꼈습니다. 
...
#### **4. 결론 작성 종합 평가**: 
기존의 연구와 어떠한 차별점이 있으며 이 때문에 어떠한 학문적 가치가 생기는지에 대한 부분이 추가되면 좋을 것 같습니다. 또한 요약 부분이 아주 조금 길다고 생각합니다. 

## 5. 총평 (앞서 언급된 내용 제외했습니다)

### A. 표현, 형식, 구성 측면에 대한 평가

과제 설명이랑 최종안은 삭제하셔야 할 것 같습니다.

### B. 논증에 대한 평가

논제에서부터 경제 성장을 장기적 관점을 제한함으로써 논증에 대한 반박을 차단하고 기업가의 입장을 고수할 수 있었다는 점에서 탁월하다고 생각합니다. 다만 기업가(맥락상 혁신가)의 역할이 중요한 것은 당연하지만 왜 대중과 같은 다른 경제 주체보다 기업가에 주목하고자 했는지에 대한 설명이 추가되면 좋을 것 같습니다. 