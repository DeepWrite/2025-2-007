---
title: 008-10 남승범의 코멘트b (과제-08) 
layout: home
nav_order: 10
parent: 008-12 안채연 (과제-08)
permalink: /asmt-08/008-12/comment-008-10
---
...
부유세는 생산성을 해치는가? 라는 제목에서부터 논제가 명확히 식별되며, 생산성을 해치지 않는다는 내용이 이후 전개되어 필자의 의도를 명확하게 파악할 수 있다.
...
글 전체적으로 논제와 논증, 사례와 재진술문이 중복되는 부분은 없으며, 잘 구분된다.
...
논문이 다루는 딜레마가 명확히 제시되었으며, '부유세는 투자에 어떤 영향을 미치는가?'라는 세부 쟁점이 명확히 소개되어 있다.
...
부유세가 생산적 투자를 유도한다는 주장이 명확히 제시되어 있고, 논쟁의 여지 역시 존재하며, 이를 해명한다면 부유세의 주요 비판 근거 중 하나인 투자를 억제한다는 비판을 해소할 수 있으므로 해명할 학문적 실익이 있다.
...
서론에서 논증 전략이 명확하게 기술되었으며, 논증과 반론에서 명확한 오류가 없고 적절한 근거에 의해 논증이 뒷받침되고 있다.
...
#### **5. 서론 작성 종합 평가**: 
사회적 배경과 기존의 학술적 논쟁이 잘 서술되어 있으며, 해당 논쟁에서 본인의 진입점(부유세 정책은 생산적 투자를 유도하는 제도적 장치이므로 정당하다)을 찾고 자신의 논증 전력을 구체적으로 서술하고 있다.
...
본론은 '투자 행동은 기대수익과 위험의 균형에 따라 이뤄진다.' -> '부유세 제도 하에서 자산을 가지고 있으면 손해이므로 개인은 투자를 한다.' -> 생산적 차원에 대한 투자가 기대수익과 위험의 균형 정도를 나타내는 샤프 라티오가 높으므로 투자될 가능성이 높다.' -> '따라서 부유세 도입은 생산적 분야에 있어 투자를 가져온다'의 구조이다. 연역적 구조 자체는 성립하나, 전제 1과 전제 2의 위치를 바꿔야 할 것으로 보인다. 전제 1은 전제 3과 이어지는 내용이며, 전제 2와는 선후관계를 갖는다. 따라서 전제 2, 전제 1, 전제 3의 순서로 전개되면 글을 이해하는 것에 도움을 줄 것이다.
반론 부분은 잘 서술되어 있고, 글을 읽으며 떠오르는 의문을 정확히 지적하고 그를 잘 해소하고 있다.
...
#### **4. 결론 작성 종합 평가**: 
본론의 내용을 잘 요약하고 재강조하였다. 또한 논의의 흐름 역시 다시 한 번 되짚어주어 글의 이해를 돕는다. 글이 갖는 의의 역시 합리적인 범위에서 서술되었으며, 주장이 미치는 범위 역시 잘 서술되어 있다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

표현, 형식, 구성 측면에서 특별히 수정할 것은 없어 보인다.

### B. 논증에 대한 평가

서론 부분은 사회적 배경과 기존 논의, 자신의 쟁점과 논증 전략이 잘 서술되어 있다.
본론 부분은 전제가 제시되는 순서가 잘못되어 글의 이해가 어려운데, 순서만 바꾼다면 더 이해가 쉽게 될 것으로 보인다.
