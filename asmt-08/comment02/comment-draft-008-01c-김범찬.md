---
title: 008-01 김범찬의 코멘트c (과제-08) 
layout: home
nav_order: 01
parent: 008-20 조재성 (과제-08)
permalink: /asmt-08/008-20/comment-008-01
---
...
서론이 주어진 조건에 따라 이해하기 쉽게 잘 서술되었다.
...
국가 개입의 요건, 가짜뉴스 시장의 평가, 그리고 국가 개입의 최후성을 명확히 정리하고 논증하였다.
...
가짜뉴스를 정보의 전달 측면이 아니라 시장 구조 자체에 주목해 풀어냄으로써 논쟁의 여지가 있는 주제를 명확하게 논증하였다.
...
#### **5. 서론 작성 종합 평가**: 
학술적 논쟁, 그로부터 유도되는 해결하고자 하는 딜레마, 논증 전략이 세부적으로 잘 구성되었다.
...
#### **3. 본론 작성 종합 평가**: 
서론에서 소개된 방식에 따라 충실히 논증이 진행되고 있다. 다만 서론과 전반적인 글의 논조에 따르면 이 글은, "여러가지 조건과 맥락을 고려해보니 국가의 개입이 정당화된다."라는 주장을 하고 있는 것으로 보임에도 불구하고, 본론 1과 3 부분에서 국가의 개입이 당위성을 지닌 책무인 것처럼 묘사되고 있다. 다시 말해 "국가는 개입할 수 있어야 한다."와 "국가는 개입해야만 한다." 중 어떤 주장을 하는 것인지 본론에서 조금 더 명확하게 서술한다면 이해가 용이할 것 같다.
...
#### **4. 결론 작성 종합 평가**: 
본론의 주장을 이해하기 쉽게 요약하고 제시하였다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

표현, 형식, 구성 측면에서 논리적으로 잘 전개된 글이라고 생각한다.

### B. 논증에 대한 평가

본론 일부 부분에서 국가 개입의 허용 vs 국가 개입의 당위가 충돌하는 듯한 지점이 있는데, 이 부분이 명확해진다면 훨씬 논증이 깔끔할 것 같다.